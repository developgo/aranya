...
// internal pod status.
func (m *Manager) GenerateAPIPodStatus(pod *corev1.Pod, podStatus *kubeletContainer.PodStatus) *corev1.Pod {
	s := m.ConvertPodStatusToAPIPodStatus(pod, podStatus)
...
// ConvertPodStatusToAPIPodStatus creates an api PodStatus for the given pod from
// the given internal pod status.  It is purely transformative and does not
// alter the kubelet state at all.
func (m *Manager) ConvertPodStatusToAPIPodStatus(pod *corev1.Pod, podStatus *kubeletContainer.PodStatus) *corev1.PodStatus {
	var (
		apiPodStatus corev1.PodStatus
		oldPodStatus corev1.PodStatus
	)
...
func (m *Manager) ConvertToAPIContainerStatuses(pod *corev1.Pod, podStatus *kubeletContainer.PodStatus, previousStatus []corev1.ContainerStatus, containers []corev1.Container, hasInitContainers, isInitContainer bool) []corev1.ContainerStatus {
