...
func (Data_Kind) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_connectivity_e95ef02dd339c4ec, []int{1, 0}
}
...
func (PodCmd_Action) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_connectivity_e95ef02dd339c4ec, []int{7, 0}
}
...
func (*Ack) Descriptor() ([]byte, []int) {
	return fileDescriptor_connectivity_e95ef02dd339c4ec, []int{0}
}
...
func (*Ack_Hash) Descriptor() ([]byte, []int) {
	return fileDescriptor_connectivity_e95ef02dd339c4ec, []int{0, 0}
}
...
func (*Data) Descriptor() ([]byte, []int) {
	return fileDescriptor_connectivity_e95ef02dd339c4ec, []int{1}
}
...
func (*Pod) Descriptor() ([]byte, []int) {
	return fileDescriptor_connectivity_e95ef02dd339c4ec, []int{2}
}
...
type Pod_SandboxStatusV1Alpha2_ struct {
	SandboxStatusV1Alpha2 *Pod_SandboxStatusV1Alpha2 `protobuf:"bytes,11,opt,name=sandbox_status_v1alpha2,json=sandboxStatusV1alpha2,proto3,oneof"`
}

func (*Pod_SandboxStatusV1Alpha2_) isPod_SandboxStatus() {}
...
func (m *Pod) GetSandboxStatusV1Alpha2() *Pod_SandboxStatusV1Alpha2 {
	if x, ok := m.GetSandboxStatus().(*Pod_SandboxStatusV1Alpha2_); ok {
		return x.SandboxStatusV1Alpha2
	}
	return nil
}
...
type Pod_ContainerStatusV1Alpha2_ struct {
	ContainerStatusV1Alpha2 *Pod_ContainerStatusV1Alpha2 `protobuf:"bytes,21,opt,name=container_status_v1alpha2,json=containerStatusV1alpha2,proto3,oneof"`
}

func (*Pod_ContainerStatusV1Alpha2_) isPod_ContainerStatus() {}
...
func (m *Pod) GetContainerStatusV1Alpha2() *Pod_ContainerStatusV1Alpha2 {
	if x, ok := m.GetContainerStatus().(*Pod_ContainerStatusV1Alpha2_); ok {
...
func (*Pod) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _Pod_OneofMarshaler, _Pod_OneofUnmarshaler, _Pod_OneofSizer, []interface{}{
		(*Pod_SandboxStatusV1Alpha2_)(nil),
		(*Pod_ContainerStatusV1Alpha2_)(nil),
	}
}
...
func _Pod_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Pod_SandboxStatusV1Alpha2_:
		b.EncodeVarint(11<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.SandboxStatusV1Alpha2); err != nil {
			return err
		}
	case nil:
	default:
...
func _Pod_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*Pod)
	switch tag {
	case 11: // sandbox_status.sandbox_status_v1alpha2
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Pod_SandboxStatusV1Alpha2)
		err := b.DecodeMessage(msg)
		m.SandboxStatus = &Pod_SandboxStatusV1Alpha2_{msg}
		return true, err
	case 21: // container_status.container_status_v1alpha2
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Pod_ContainerStatusV1Alpha2)
		err := b.DecodeMessage(msg)
		m.ContainerStatus = &Pod_ContainerStatusV1Alpha2_{msg}
		return true, err
	default:
		return false, nil
	}
...
func _Pod_OneofSizer(msg proto.Message) (n int) {
	...
	switch x := m.SandboxStatus.(type) {
	case *Pod_SandboxStatusV1Alpha2_:
		s := proto.Size(x.SandboxStatusV1Alpha2)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case nil:
...
func (m *Pod_ContainerStatusV1Alpha2) String() string { return proto.CompactTextString(m) }
func (*Pod_ContainerStatusV1Alpha2) ProtoMessage()    {}
func (*Pod_ContainerStatusV1Alpha2) Descriptor() ([]byte, []int) {
	return fileDescriptor_connectivity_e95ef02dd339c4ec, []int{2, 0}
}
func (m *Pod_ContainerStatusV1Alpha2) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_Pod_ContainerStatusV1Alpha2.Unmarshal(m, b)
}
...
func (dst *Pod_ContainerStatusV1Alpha2) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Pod_ContainerStatusV1Alpha2.Merge(dst, src)
}
func (m *Pod_ContainerStatusV1Alpha2) XXX_Size() int {
	return xxx_messageInfo_Pod_ContainerStatusV1Alpha2.Size(m)
}
...
type Pod_SandboxStatusV1Alpha2 struct {
	V1Alpha2             [][]byte `protobuf:"bytes,1,rep,name=v1alpha2,proto3" json:"v1alpha2,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *Pod_SandboxStatusV1Alpha2) Reset()         { *m = Pod_SandboxStatusV1Alpha2{} }
func (m *Pod_SandboxStatusV1Alpha2) String() string { return proto.CompactTextString(m) }
func (*Pod_SandboxStatusV1Alpha2) ProtoMessage()    {}
func (*Pod_SandboxStatusV1Alpha2) Descriptor() ([]byte, []int) {
	return fileDescriptor_connectivity_e95ef02dd339c4ec, []int{2, 1}
}
func (m *Pod_SandboxStatusV1Alpha2) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_Pod_SandboxStatusV1Alpha2.Unmarshal(m, b)
}
func (m *Pod_SandboxStatusV1Alpha2) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_Pod_SandboxStatusV1Alpha2.Marshal(b, m, deterministic)
}
func (dst *Pod_SandboxStatusV1Alpha2) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Pod_SandboxStatusV1Alpha2.Merge(dst, src)
}
func (m *Pod_SandboxStatusV1Alpha2) XXX_Size() int {
	return xxx_messageInfo_Pod_SandboxStatusV1Alpha2.Size(m)
}
func (m *Pod_SandboxStatusV1Alpha2) XXX_DiscardUnknown() {
	xxx_messageInfo_Pod_SandboxStatusV1Alpha2.DiscardUnknown(m)
}

var xxx_messageInfo_Pod_SandboxStatusV1Alpha2 proto.InternalMessageInfo

func (m *Pod_SandboxStatusV1Alpha2) GetV1Alpha2() [][]byte {
	if m != nil {
		return m.V1Alpha2
	}
	return nil
...
func (*Node) Descriptor() ([]byte, []int) {
	return fileDescriptor_connectivity_e95ef02dd339c4ec, []int{3}
}
...
func (*Msg) Descriptor() ([]byte, []int) {
	return fileDescriptor_connectivity_e95ef02dd339c4ec, []int{4}
}
...
func (*Cmd) Descriptor() ([]byte, []int) {
	return fileDescriptor_connectivity_e95ef02dd339c4ec, []int{5}
}
...
func (*NodeCmd) Descriptor() ([]byte, []int) {
	return fileDescriptor_connectivity_e95ef02dd339c4ec, []int{6}
}
...
func (*PodCmd) Descriptor() ([]byte, []int) {
	return fileDescriptor_connectivity_e95ef02dd339c4ec, []int{7}
}
...
func (*CreateOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_connectivity_e95ef02dd339c4ec, []int{8}
}
...
func (*CreateOptions_PodV1) Descriptor() ([]byte, []int) {
	return fileDescriptor_connectivity_e95ef02dd339c4ec, []int{8, 0}
}
...
func (*DeleteOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_connectivity_e95ef02dd339c4ec, []int{9}
}
...
func (*ListOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_connectivity_e95ef02dd339c4ec, []int{10}
}
...
func (*LogOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_connectivity_e95ef02dd339c4ec, []int{11}
}
...
func (*ExecOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_connectivity_e95ef02dd339c4ec, []int{12}
}
...
func (*PortForwardOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_connectivity_e95ef02dd339c4ec, []int{13}
}
...
func (*InputOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_connectivity_e95ef02dd339c4ec, []int{14}
}
...
func (*TtyResizeOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_connectivity_e95ef02dd339c4ec, []int{15}
}
...
func init() {
	...
	proto.RegisterType((*Pod_SandboxStatusV1Alpha2)(nil), "connectivity.Pod.SandboxStatusV1alpha2")
...
func init() { proto.RegisterFile("connectivity.proto", fileDescriptor_connectivity_e95ef02dd339c4ec) }

var fileDescriptor_connectivity_e95ef02dd339c4ec = []byte{
	...
	,
}
