...
type Pod_SandboxV1Alpha2 struct {
	SandboxV1Alpha2 *Pod_SandboxStatusV1Alpha2 `protobuf:"bytes,11,opt,name=sandbox_v1alpha2,json=sandboxV1alpha2,proto3,oneof"`
}
...
func (m *Pod) GetSandboxV1Alpha2() *Pod_SandboxStatusV1Alpha2 {
...
func _Pod_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Pod_SandboxV1Alpha2:
		...
		if err := b.EncodeMessage(x.SandboxV1Alpha2); err != nil {
			return err
		}
	case nil:
	default:
...
func _Pod_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 11: // sandbox_status.sandbox_v1alpha2
		...
		m.SandboxStatus = &Pod_SandboxV1Alpha2{msg}
		return true, err
...
func _Pod_OneofSizer(msg proto.Message) (n int) {
	...
	switch x := m.SandboxStatus.(type) {
	case *Pod_SandboxV1Alpha2:
		s := proto.Size(x.SandboxV1Alpha2)
		n += 1 // tag and wire
...
func (*Pod_SandboxStatusV1Alpha2) Descriptor() ([]byte, []int) {
	return fileDescriptor_97b3080873330fb4, []int{1, 1}
}
...
func (m *Pod_SandboxStatusV1Alpha2) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Pod_SandboxStatusV1Alpha2.Merge(m, src)
}
...
func (*Pod_SandboxStatusV1Alpha2) XXX_MessageName() string {
	return "connectivity.Pod.SandboxStatusV1alpha2"
}
...
var fileDescriptor_97b3080873330fb4 = []byte{
	...
	,
}
...
func (this *Pod_SandboxV1Alpha2) Equal(that interface{}) bool {
	...
	if !this.SandboxV1Alpha2.Equal(that1.SandboxV1Alpha2) {
		return false
	}
	return true
}
...
func (this *Pod_SandboxStatusV1Alpha2) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*Pod_SandboxStatusV1Alpha2)
	if !ok {
		that2, ok := that.(Pod_SandboxStatusV1Alpha2)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *Pod_SandboxStatusV1Alpha2) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&connectivity.Pod_SandboxStatusV1Alpha2{")
	s = append(s, "V1Alpha2: "+fmt.Sprintf("%#v", this.V1Alpha2)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *Pod) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Namespace) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintMsgDetail(dAtA, i, uint64(len(m.Namespace)))
...
func (m *Pod_SandboxV1Alpha2) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.SandboxV1Alpha2 != nil {
		dAtA[i] = 0x5a
		i++
		i = encodeVarintMsgDetail(dAtA, i, uint64(m.SandboxV1Alpha2.Size()))
		n4, err := m.SandboxV1Alpha2.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n4
...
func (m *Pod_SandboxStatusV1Alpha2) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *Pod_SandboxStatusV1Alpha2) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *Pod_SandboxStatusV1Alpha2) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *Pod_SandboxV1Alpha2) String() string {
	...
	s := strings.Join([]string{`&Pod_SandboxV1Alpha2{`,
		`SandboxV1Alpha2:` + strings.Replace(fmt.Sprintf("%v", this.SandboxV1Alpha2), "Pod_SandboxStatusV1Alpha2", "Pod_SandboxStatusV1Alpha2", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *Pod_SandboxStatusV1Alpha2) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&Pod_SandboxStatusV1Alpha2{`,
		`V1Alpha2:` + fmt.Sprintf("%v", this.V1Alpha2) + `,`,
		`}`,
	}, "")
	return s
...
func (m *Pod_SandboxStatusV1Alpha2) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SandboxStatusV1alpha2: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SandboxStatusV1alpha2: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
