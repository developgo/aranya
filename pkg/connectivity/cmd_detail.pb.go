...
const (
	RejectedByAlreadyConnected    RejectReason = 0
	RejectedByPodStatusSyncError  RejectReason = 1
	RejectedByNodeStatusSyncError RejectReason = 2
)

var RejectReason_name = map[int32]string{
	0: "RejectedByAlreadyConnected",
	1: "RejectedByPodStatusSyncError",
	2: "RejectedByNodeStatusSyncError",
}
...
func (SecurityOptions_ProcMountKind) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_1571bcd24e248579, []int{6, 0}
}

type RejectCmd struct {
	Reason  RejectReason `protobuf:"varint,1,opt,name=reason,proto3,enum=connectivity.RejectReason" json:"reason,omitempty"`
...
func (m *RejectCmd) GetReason() RejectReason {
	if m != nil {
		return m.Reason
	}
	return RejectedByAlreadyConnected
}
...
func (*RejectCmd) XXX_MessageName() string {
	return "connectivity.RejectCmd"
}
...
func (*TtyResizeOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_1571bcd24e248579, []int{17}
}
...
func init() {
	proto.RegisterEnum("connectivity.RejectReason", RejectReason_name, RejectReason_value)
	...
	proto.RegisterType((*RejectCmd)(nil), "connectivity.RejectCmd")
...
var fileDescriptor_1571bcd24e248579 = []byte{
	...
	,
}

func (x RejectReason) String() string {
	s, ok := RejectReason_name[int32(x)]
	if ok {
		return s
	}
...
func (this *RejectCmd) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&connectivity.RejectCmd{")
...
func (m *RejectCmd) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Reason != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintCmdDetail(dAtA, i, uint64(m.Reason))
	}
	if len(m.Message) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintCmdDetail(dAtA, i, uint64(len(m.Message)))
...
func (m *RejectCmd) Size() (n int) {
	...
	_ = l
	if m.Reason != 0 {
		n += 1 + sovCmdDetail(uint64(m.Reason))
	}
	l = len(m.Message)
	if l > 0 {
